...
CFG_SEC_FLOW_LOGCONF = "odem_logging.ini"
CFG_SEC_FLOW_LOG_DIR = "local_log_dir"
CFG_SEC_FLOW_LOGFILE = "local_service_logfile"
CFG_SEC_FLOW_LOGNAME = "local_service_logname"
